 ...
 * 方法来统计线程池的执行情况
 */
public class PoolMonitorTest extends ThreadPoolExecutor {

    private static final Logger LOGGER = LoggerFactory.getLogger(PoolMonitorTest.class);
     ...
     */
    public PoolMonitorTest(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit, BlockingQueue<Runnable> workQueue,
                           String poolName) {
    ...
    public static ExecutorService newFixedThreadPool(int nThreads, String poolName) {
        return new PoolMonitorTest(nThreads, nThreads, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>(), poolName);
    }
    ...
    public static ExecutorService newCachedThreadPool(String poolName) {
        return new PoolMonitorTest(0, Integer.MAX_VALUE, 60L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), poolName);
    }
